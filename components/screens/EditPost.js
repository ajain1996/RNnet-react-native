...
export default function EditPostScreen({ navigation, route }) {
    ...
    const submitPost = async () => {
        ...
        firestore()
            ...
            .then(() => {
                ...
                ToastAndroid.show('Your post has been updated Successfully!', ToastAndroid.SHORT);
                // alert(
                //     'Post published!',
                //     '',
                // );
    ...
    const uploadImage = async () => {
        ...
        //         console.log(`${makeid(10)}.jpg has been successfully uploaded.`);
        //     })
    ...
    return (
        <ScrollView>
            <View style={styles.container}>
                ...
                {/* <Text>{route.params.postInfo}</Text> */}
